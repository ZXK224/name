...
class YP:
    ...
    def send_request(self, url, headers, data=None, method='GET', cookies=None):
        with requests.Session() as session:
            ...
            try:
                ...
                print("请求错误:", str(e), "响应内容:", response.text)
                #print("请求错误:", str(e))
    ...
    # 获取可兑换商品列表
    # def get_shop(self):
    #     url = "https://mrp.mcloud.139.com/market/signin/page/exchangeList?client=app&clientVersion=11.1.1"
    ...
    # 本意想写根据积分自动兑换商品，后来想想完全没必要，根本用不到哈
    ...
    def rob_cash(self):
        ...
        url = f'https://mrp.mcloud.139.com/market/signin/page/exchange?prizeId={self.cash}&client=app&clientVersion=11.1.1'
        ...
        if return_data.get('msg') != 'success':
            ...
            return return_data.get('msg')

        serv_number = return_data['result']['servNumber']
        prize_name = return_data['result']['prizeName']
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=100) as executor:
        futures = {executor.submit(thread, cookie): index for index, cookie in enumerate(cookies)}
